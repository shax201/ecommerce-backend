...
import { UserManagementModel } from '../src/app/user/userManagement/userManagement.model';
import AdminModel from '../src/app/user/admin/admin.model';
import ClientModel from '../src/app/user/client/client.model';
...
const runMigration = async () => {
  try {
    ...
    switch (command) {
      ...
      default:
        console.log('Usage: bun run migrate-users.ts [migrate|verify|rollback]');
